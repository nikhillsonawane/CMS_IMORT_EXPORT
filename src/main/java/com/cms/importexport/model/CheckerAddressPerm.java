...
@Data
@NoArgsConstructor
public class CheckerAddressPerm {

	private Long cmsCheckerAddressPermId;
    ...
    static public class COLUMNS_NAMES {
        ...
        public static String CMS_CHECKER_ADDRESS_PERM_ID = "CMS_CHECKER_ADDRESS_PERM_ID";
        ...
        public static String LAST_UPDATE_BY = "LAST_UPDATED_BY";
